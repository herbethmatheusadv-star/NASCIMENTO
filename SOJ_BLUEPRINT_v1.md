...
- **Onda 3 — Conhecimento:** Fase 5 das skills (bancario_ccb com modo defesa nativo; consumidor_aguas) preservando 100% do conteúdo validado no contrato da seção 9; esqueletos trabalhista/ e previdenciário/ (praxe e templates vazios de propósito — nascem do caso 1); camada de PRAXE LOCAL na árvore como anotação com contagem e fontes (sentenças do Acervo), recomendação só com ≥3 amostras consistentes do mesmo juízo, e local divergindo do nacional = sempre Tier B.
