...
Gerado em 2026-07-07 12:03 por gerar_views.py — não editar. Fonte: frontmatter dos STATUS.md de cada caso.
...
|---|---|---|---|---|---|---|---|---|---|
| DAIANE | 2026-0004 | NASCIMENTO FERRO E ACO + DAIANE x adm. perfil Babados de Canaa - Obrigacao de fazer c/c danos morais e exibicao de dados | E3_minuta | pre_protocolo | aprovado | aprovado | pendente | — | 2 |
