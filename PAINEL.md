...
Gerado em 2026-07-07 11:26 por gerar_views.py — não editar. Fonte: frontmatter dos STATUS.md de cada caso.
...
|---|---|---|---|---|---|---|---|---|---|
| DAIANE | 2026-0004 | NASCIMENTO FERRO E ACO + DAIANE x adm. perfil Babados de Canaa - Obrigacao de fazer c/c danos morais e exibicao de dados | E2_estrategia | pre_protocolo | aprovado | reprovado | pendente | — | 3 |
