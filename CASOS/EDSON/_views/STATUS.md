...
caso_id: 2026-0006
cliente: EDSON
titulo: "Edson x Ferreira Representacoes e Lima Financeira — NULIDADE de contrato de intermediacao de consorcio c/c restituicao integral e danos morais"
area: consumidor
fase: E1_intake
...
**Cliente/pasta:** EDSON · **Caso:** 2026-0006 · **Área:** consumidor · **Módulo:** consumidor_consorcio
**Fase interna:** E1_intake · **Fase processual:** pre_protocolo · **Complexidade:** complexo · **Segredo de justiça:** não
**Gates:** G1 reprovado (2026-07-22) · G2 pendente · G3 pendente
...
- PEN11 (advogado): EXISTE CHECAGEM TELEFONICA GRAVADA DO EDSON? — descoberto na leitura INTEGRAL da sentenca do caso gemeo (0814910-72.2024). La, a gravacao de checagem (ID 139915707) foi juntada PELA DEFESA e foi o que DERRUBOU o autor: o juiz disse que ela 'corrobora a versao de que o autor foi devidamente informado'. O contrato do Edson (P01 p.7) diz que ele 'esta ciente e autoriza a checagem telefonica gravada'. PERGUNTAR AO CLIENTE se recebeu ligacao de confirmacao/checagem e o que respondeu — ANTES de redigir. ATENCAO: eu havia recomendado PEDIR a exibicao dessa gravacao na inicial; era erro — seria antecipar a municao deles. CONTRA-ATAQUE se ela existir: no proprio caso gemeo o juiz registrou que 'um representante da JFERREIRA ORIENTA O CONSUMIDOR A FALAR que nao houve pagamento de quantia' e ainda assim validou a checagem; checagem roteirizada pelo fornecedor nao prova ciencia, prova encenacao. Varrer os 122 audios procurando roteirizacao semelhante. — bloqueia G2, G3

## Números do caso
- Partes: 3 · Fatos: 17 (provados 17 / alegados 0 / controversos 0) · Provas: 8 · Pedidos: 3 · Pendências abertas: 6
